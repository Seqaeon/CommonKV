...
def run_continuation(method, model, tokenizer, max_new_tokens=None,
    ...
    for prompt_idx, prompt in enumerate(CONTINUATION_PROMPTS):
        ...
        #  - Level 5 proxy: text-level perplexity delta vs FullKV continuation.
        #    NOTE: this is a practical proxy computed on generated continuations,
        #    not the paper-style corpus-level ΔPPL under identical references.
